...
parser.add_argument('--wv_file', default='dataset/glove/glove.840B.300d.txt',
...
trn_file = 'dataset/SQuAD/train-v1.1.json'
dev_file = 'dataset/SQuAD/dev-v1.1.json'
...
with open('dataset/SQuAD/intermediate.msgpack', 'wb') as f:
    msgpack.dump([train, dev], f)
...
with open('dataset/SQuAD/meta.msgpack', 'wb') as f:
    msgpack.dump(meta, f)
result = {
    'train': train,
    'dev': dev
...
if args.sample_size:
    ...
    with open('dataset/SQuAD/sample.msgpack', 'wb') as f:
